    ...
    public void insert(Object obj)
    {
        ...
        if (this.IamIncreasing)
         for (this.myCurrent = this.myFirst;
                 this.myCurrent != null &&
                 (((java.lang.Comparable)this.myCurrent.d).compareTo(obj) < 0);
    ...
    public void sort()
    {
        ...
        while (should_continue)
        {
                                    ...
                                    this.myCurrent = this.myCurrent.next)
            {
                ...
                if (old_current != null)
                {
                    java.lang.Comparable current_obj = (java.lang.Comparable)this.myCurrent.d;
                        if (this.IamIncreasing)
                        should_swap = (current_obj.compareTo(old_current.d) > 0);
                        else
                        should_swap = (current_obj.compareTo(old_current.d) < 0);
                        if (should_swap)
                        {
...
//--------------------------------------------------------------------------
    ...
    public boolean check()
    {
        ...
        {
            java.lang.Comparable current_obj = (Comparable)sd.d;
            if (prev_obj != null)
                if (( this.IamIncreasing && (current_obj.compareTo(prev_obj) < 0))
                ||  (!this.IamIncreasing && (current_obj.compareTo(prev_obj) > 0)))
                {
